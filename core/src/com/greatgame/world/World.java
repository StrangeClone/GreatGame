...
public class World {
    ...
    private Characteristic parseCharacteristic(String token) throws IOException {
        if ("Agility".equals(token)) {
            ...
            throw new ParsingException("Unexpected characteristic");
        }
    }
    ...
    private ModeName parseMode(Scanner reader) throws ParsingException {
        ...
        if ("explorationMode".equals(token)) {
            ...
            throw new ParsingException("Unexpected mode");
        }
    }
