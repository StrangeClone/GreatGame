...
public class StandardWorldGenerator implements WorldGenerator {
    ...
    public StandardWorldGenerator(long seed, Scanner alreadyGeneratedLocationsStream) throws IOException {
        locationMap = new HashMap<>();
        this.seed = seed;
        readLocations(alreadyGeneratedLocationsStream);
    }

    private void readLocations(Scanner scanner) throws IOException {
